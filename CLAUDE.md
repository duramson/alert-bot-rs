...
This project is indexed by GitNexus as **alert-bot-rs** (367 symbols, 795 relationships, 31 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
